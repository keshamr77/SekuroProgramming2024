...
class MagnitudeCalculationRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MagnitudeCalculationRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MagnitudeCalculationRequest
    let len;
    let data = new MagnitudeCalculationRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MagnitudeCalculationRequest(null);
...
class MagnitudeCalculationResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.magnitude = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MagnitudeCalculationResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MagnitudeCalculationResponse
    let len;
    let data = new MagnitudeCalculationResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MagnitudeCalculationResponse(null);
...
module.exports = {
  Request: MagnitudeCalculationRequest,
  Response: MagnitudeCalculationResponse,
  md5sum() { return '55d1a215f43fd1f64eb105a505b172c4'; },
  datatype() { return 'demo_package/MagnitudeCalculation'; }
};
